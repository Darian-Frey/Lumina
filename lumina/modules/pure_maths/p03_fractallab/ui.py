...
class FractalLabWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._spin_power.setFixedWidth(80)
        ...
        jl = QVBoxLayout(jg)
        r = QHBoxLayout()
        rlbl = QLabel("Real part:")
        rlbl.setFixedWidth(110)
        rlbl.setFont(QFont("sans-serif", 9))
        r.addWidget(rlbl)
        ...
        self._spin_cr.setFixedWidth(80)
        r.addWidget(self._spin_cr)
        jl.addLayout(r)
        r2 = QHBoxLayout()
        ilbl = QLabel("Imag part:")
        ilbl.setFixedWidth(110)
        ilbl.setFont(QFont("sans-serif", 9))
        r2.addWidget(ilbl)
        ...
        self._spin_ci.setFixedWidth(80)
        ...
        il = QVBoxLayout(ig)
        r3 = QHBoxLayout()
        itlbl = QLabel("Max iterations:")
        itlbl.setFixedWidth(110)
        itlbl.setFont(QFont("sans-serif", 9))
        r3.addWidget(itlbl)
